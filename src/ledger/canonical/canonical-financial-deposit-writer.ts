...
function validateCapture(capture: CanonicalFinancialDepositCapture): void {
  ...
  > = {
    ...
    "yuanta-fund/investment/margin-canonical-v1": {
      postingOrigin: "provider_booked_history",
      postingBasis: "statement-posted-history",
      ruleVersion: "yuanta-fund/investment/margin-canonical-v1",
      effectiveTimeBasis: "source-reported",
      postingStatus: "posted",
      timeZone: "Asia/Taipei",
      timePrecision: "date",
      ...
      completenessRuleVersion: "yuanta-fund/investment/margin-canonical-v1",
      absenceAuthority: null,
      withdrawalPolicy: "never-infer",
      integrationNamespace: "yuanta-fund",
      stream: "investment-margin",
      recordKind: "investment-margin-borrowing",
      contractVersion: "yuanta-fund/investment/margin-canonical-v1",
      requireProviderGuaranteedFalse: true,
    },
    "yuanta-trade/investment/margin-canonical-v1": {
      postingOrigin: "provider_booked_history",
      postingBasis: "statement-posted-history",
      ruleVersion: "yuanta-trade/investment/margin-canonical-v1",
      effectiveTimeBasis: "source-reported",
      postingStatus: "posted",
      timeZone: "Asia/Taipei",
      timePrecision: "date",
      completeness: "complete-range",
      completenessBasis: "source-reported-independent-margin-balance",
      completenessRuleVersion: "yuanta-trade/investment/margin-canonical-v1",
      absenceAuthority: null,
      withdrawalPolicy: "never-infer",
      integrationNamespace: "yuanta-trade",
      stream: "investment-margin",
      recordKind: "investment-margin-borrowing",
      contractVersion: "yuanta-trade/investment/margin-canonical-v1",
      requireProviderGuaranteedFalse: true,
    },
