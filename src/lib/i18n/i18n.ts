...
const en = {
  ...
  statements: {
    ...
    statement: "Statement",
    statementTransactionCount: (count: number) => `${count} statement ${count === 1 ? "transaction" : "transactions"}`,
...
const zh: typeof en = {
  ...
  statements: {
    ...
    notObserved: "尚未觀測",
    statement: "對帳單",
    statementTransactionCount: (count) => `${count} 筆對帳單交易`,
    statementTransactions: "對帳單交易",
    evidence: "查看對帳單證據",
    statementId: "對帳單 ID",
