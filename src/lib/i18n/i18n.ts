...
const en = {
  ...
  automation: {
    ...
    viewLogs: "View logs",
    activeLogsTitle: "Running task logs",
    activeLogsDescription: (count: number) => `Live logs from ${count} running tasks`,
    startSync: "Start sync",
    stopAll: "Stop all",
    runnableTaskHeading: (count: number) => `${count} tasks can run together`,
    runningTaskHeading: (count: number) => `${count} tasks are running`,
    syncDialogTitle: "Run tasks together",
    syncDialogDescription: (count: number) => `${count} independent tasks will start at the same time.`,
    ...
    collectStageDescription: "Independent statement tasks can run together.",
    importStage: "Import transactions",
    importStageDescription: "Runs after its statement dependencies finish.",
    syncStage: "Sync data",
    syncStageDescription: "Independent account and exchange-rate updates.",
    showAllTasks: (count: number) => `Show all ${count} tasks`,
...
const zh: typeof en = {
  ...
  automation: {
    ...
    viewLogs: "查看日誌",
    activeLogsTitle: "執行中任務日誌",
    activeLogsDescription: (count) => `集中顯示 ${count} 個執行中任務的即時日誌`,
    startSync: "開始同步",
    stopAll: "停止全部",
    runnableTaskHeading: (count) => `${count} 個任務可以同步執行`,
    ...
    collectStage: "取得對帳單",
    collectStageDescription: "互不依賴的對帳單任務可同步執行。",
    importStage: "匯入交易資料",
    importStageDescription: "上游對帳單完成後即可執行。",
    syncStage: "同步資料",
    syncStageDescription: "獨立更新帳戶與匯率資料。",
