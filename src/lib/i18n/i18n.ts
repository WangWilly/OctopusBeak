...
const en = {
  ...
  dataIssues: {
    ...
    creatingIssue: "Creating data issue…",
    issueCreatedReady: "Data issue created and loaded.",
    ...
    handleIncorrectImports: "Handle incorrect imports",
    open: "Open",
    ...
    eventCreated: "Data issue created",
    eventDiagnosis: "Diagnosis started",
    eventExclusionPreview: "Exclusion preview created",
    eventExclusion: "Source version excluded",
    eventRestorePreview: "Restore preview created",
  ...
  statements: {
    title: "Statements",
    accountTitle: (account: string) => `${account} Statements`,
    cycle: "Statement cycle",
    issueDate: "Issued",
    dueDate: "Due",
    statementBalance: "Statement balance",
    minimumPayment: "Minimum payment",
    providerBalance: "Current provider balance",
    amountDue: "Provider amount due",
    creditLimit: "Credit limit",
    notObserved: "Not observed",
    membershipCount: (count: number) => `${count} matched transactions`,
    membershipIdentity: "Canonical membership identity",
    evidence: "View statement evidence",
    statementId: "Statement ID",
    statementRevision: (revision: number) => `Statement revision ${revision}`,
    statementRevisionId: "Statement revision ID",
    statementKey: "Statement key",
    transactionId: "Transaction ID",
    transactionRevisionId: "Transaction revision ID",
    sourceRecordId: "Source record ID",
    noRows: "No canonical statements are available for this card.",
  },
  positions: {
    title: "Positions",
    ...
    units: "Units",
    value: "Value",
    valueAwaiting: "Awaiting valuation",
  ...
  automation: {
    ...
    credentialStatus: "Sign-in details status",
    syncAll: "Sync all",
    ...
    prerequisiteAffectedTasks: "Affected tasks",
    statementTypeLabels: {
      deposit: "TWD accounts",
    ...
    discardCredentialChanges: "Discard unsaved changes to sign-in details?",
    closeCredentials: "Close sign-in details",
    ...
    verificationIncomplete: "Verification is not complete yet.",
    resume: "Resume",
  ...
  firstRunWelcome: {
    ...
    assetsBody: "One route to historical changes",
    ...
    continue: "Continue",
    activateIntroduction: "Continue from the OctopusBeak introduction",
  ...
  onboarding: {
    ...
    openCredentials: "Open sign-in details",
    ...
    resumeCollection: "Verification complete, resume collection",
...
const zh: typeof en = {
  ...
  dataIssues: {
    ...
    title: "使用者回報的資料問題",
    sideLabel: "案件狀態",
    reportProblemHint: "建立可持續追蹤的案件，確認並排除單一匯入版本。",
    ...
    note: "補充說明",
    createIssue: "建立問題案件",
    creatingIssue: "正在建立資料問題…",
    issueCreatedReady: "資料問題已建立並載入。",
    ...
    eventCreated: "問題案件已建立",
    eventDiagnosis: "已開始診斷",
    eventExclusionPreview: "已建立排除預覽",
    eventExclusion: "已排除來源版本",
    eventRestorePreview: "已建立還原預覽",
    eventRestore: "已還原來源版本",
    eventBlocked: "已封鎖",
    eventFailed: "失敗",
    operationFailed: "無法完成這項操作，帳本資料未變更。請重試。",
    noOperations: "尚無操作紀錄。",
    noIssues: "尚無已回報的資料問題。",
    noSources: "此帳戶沒有可排除的有效匯入版本。",
    statusFilter: "篩選案件狀態",
    restoreImport: "還原此匯入",
    confirmRestore: "確認還原",
    restoreBlocked: "已有較新的有效帳戶資料，因此無法還原。",
    viewIssue: "查看問題案件",
    back: "返回",
    backToAccount: "回到帳戶",
    backToAccountHint: "回到此帳戶頁面",
    fileRows: "CSV 資料列",
    affectedAccounts: "受影響帳戶",
    importedAt: "匯入時間",
  },
  spending: {
    eyebrow: "消費",
  ...
  statements: {
    title: "對帳單",
    accountTitle: (account) => `${account} 對帳單`,
    cycle: "對帳週期",
    issueDate: "開立日",
    dueDate: "繳款截止日",
    statementBalance: "對帳單餘額",
    minimumPayment: "最低應繳",
    providerBalance: "目前提供者餘額",
    amountDue: "提供者應繳金額",
    creditLimit: "信用額度",
    notObserved: "尚未觀測",
    membershipCount: (count) => `${count} 筆已匹配交易`,
    membershipIdentity: "標準對帳單成員識別",
    evidence: "查看對帳單證據",
    statementId: "對帳單 ID",
    statementRevision: (revision) => `對帳單修訂版 ${revision}`,
    statementRevisionId: "對帳單修訂版 ID",
    statementKey: "對帳單鍵",
    transactionId: "交易 ID",
    transactionRevisionId: "交易修訂版 ID",
    sourceRecordId: "來源紀錄 ID",
    noRows: "此卡尚無可用的標準對帳單。",
  },
  positions: {
    title: "部位",
  ...
  automation: {
    ...
    whatYouNeed: "需要準備",
    setupSteps: "設定步驟",
    officialServices: "官方服務",
    chooseCertificateFile: "選擇憑證檔案",
    selectedCertificateFile: (filename) => `已選擇：${filename}`,
    chooseAnotherCertificateFile: "重新選擇",
    missingCertificateFile: "找不到原本的憑證檔案，請重新選擇。",
    invalidCertificateExtension: "請選擇 .pfx 或 .p12 憑證檔案。",
    unreadableCertificateFile: "無法讀取這個憑證檔案，請重新選擇。",
    ...
    prerequisiteAffectedTasks: "受影響的任務",
    statementTypeLabels: {
      deposit: "新臺幣帳戶",
    ...
    historyFailed: "失敗",
    historyDuration: "耗時",
    discardCredentialChanges: "要放棄尚未儲存的登入資料變更嗎？",
    closeCredentials: "關閉登入資料",
    closeLogs: "關閉日誌",
    ...
    noSession: "沒有工作階段",
    forceQuit: "強制結束",
    checkVerification: "確認驗證完成",
    verificationIncomplete: "驗證尚未完成。",
    resume: "繼續",
  ...
  firstRunWelcome: {
    languageHeading: "歡迎",
    languagePrompt: "選擇介面語言",
    introductionTitle: "準備放手，讓資料自己就位。",
    introductionBody: "清晰看見全貌，智慧整理每一筆，安心掌握你的財務。",
    overviewTitle: "終於清晰",
    overviewBody: "一個視野，所有資產",
    assetsTitle: "交易歸檔",
    assetsBody: "歷史追蹤，路徑直達",
    spendingTitle: "財務日記",
    spendingBody: "精彩生活，安心消費",
    automationTitle: "準備放手了嗎？",
    automationBody: "無風險自動收集帳務資料，再也不用親自填進試算表。",
    credentialsNote: "登入資料只保存在這台裝置上",
    startSetup: "開始設定",
    maybeLater: "稍後再說",
    continue: "繼續",
    activateIntroduction: "從 OctopusBeak 品牌介紹繼續",
    previous: "上一頁",
    next: "下一頁",
    languageOptions: "語言選項",
    progress: (current, total) => `第 ${current} 頁，共 ${total} 頁`,
  },
  onboarding: {
  ...
  settings: {
    ...
    languageAria: "語言選項",
    systemSettings: "系統設定",
    scheduleSettings: "時區與排程設定",
    languageDisplaySettings: "語言與顯示設定",
