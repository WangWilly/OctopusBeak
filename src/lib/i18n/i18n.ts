...
const en = {
  ...
  dataIssues: {
    ...
    errorHistory: (count: number) => `Error history · ${count}`,
    sourceAnalysis: "Source analysis",
    impactCalculation: "Impact calculation",
    lineageIncomplete: "CSV row lineage is incomplete",
    ledgerReadFailure: "Unable to read ledger",
    calculationFailed: "Calculation failed",
    blocked: "Blocked",
    technicalDetails: "Technical details",
    noLedgerChange: "Impact calculation stopped before any ledger value changed.",
    unlinkedSourceRow: "One source occurrence could not be linked to a canonical ledger row.",
    ...
    quarantineSuccessTitle: "Import quarantined in prototype",
    restoreSuccessTitle: "Import restored in prototype",
    restoreComplete: "Prototype restore complete",
  },
  spending: {
    eyebrow: "Spending",
...
const zh: typeof en = {
  ...
  dataIssues: {
    ...
    confirmSource: "確認來源",
    impactPreview: "預覽影響",
    errorHistory: (count) => `錯誤紀錄 ${count} 筆`,
    sourceAnalysis: "來源分析",
    impactCalculation: "影響計算",
    lineageIncomplete: "CSV row 關聯不完整",
    ledgerReadFailure: "無法讀取 ledger",
    calculationFailed: "計算失敗",
    blocked: "已阻擋",
    technicalDetails: "技術細節",
    noLedgerChange: "影響計算已停止，未變更任何 ledger 數值。",
    unlinkedSourceRow: "一筆來源資料無法連結至標準 ledger 資料列。",
    valueTimeline: "數值時間線",
    reportedPoint: "回報位置",
    sources: "產生目前數值的來源",
    viewRawData: "檢視原始資料列",
    ...
    auditTime: "時間",
    invalidated: "已停用",
    quarantineSuccessTitle: "Prototype 匯入已停用",
    restoreSuccessTitle: "Prototype 匯入已還原",
    restoreComplete: "Prototype 還原完成",
  },
  spending: {
    eyebrow: "消費",
    title: "個人消費",
