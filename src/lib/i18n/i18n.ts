...
const en = {
  ...
  automation: {
    ...
    taskQueueDescription: "Tasks can run in parallel. CSV import unlocks from today's persisted crawler history, not page state.",
    task: "Task",
    status: "Status",
    progress: "Progress",
...
const zh: typeof en = {
  ...
  automation: {
    ...
    credentials: "憑證",
    taskQueue: "任務佇列",
    taskQueueDescription: "任務可平行執行。CSV 匯入會依今日已保存的爬蟲歷史解鎖，不依目前頁面狀態。",
    task: "任務",
    status: "狀態",
    progress: "進度",
    latestUtc: "最新 UTC",
