...
const en = {
  ...
  onboarding: {
    ...
    chooseVerificationCopy: { title: "Select the verification field", body: "Select the verification code or OTP field directly in the bank screenshot." },
    ...
    clickVerificationField: "Click the verification field in the bank screen.",
...
const zh: typeof en = {
  ...
  onboarding: {
    ...
    clickVerificationField: "請點選銀行畫面中的驗證欄位",
