...
const en = {
  ...
  spending: {
    ...
    sideSub: (month: string, count: number) => `${month} / ${count} invoices`,
    ...
    datasetStatus: (count: number, start: string, end: string) => `${count} invoices / ${start}-${end}`,
    ...
    noSpendingBody: "Confirmed personal invoices will appear here after import.",
...
const zh: typeof en = {
  ...
  spending: {
    ...
    title: "個人消費",
    sideLabel: "每月消費",
    sideSub: (month, count) => `${month} / ${count} 張發票`,
    monthlyEyebrow: "每月消費",
    monthlyTitle: "每月消費",
    ...
    datasetStatus: (count, start, end) => `${count} 張發票 / ${start}-${end}`,
    ...
    noSpendingBody: "匯入確認後的個人發票就會顯示在這裡。",
