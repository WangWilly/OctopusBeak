...
export const YUANTA_SERVISIGN_PREREQUISITE: AutomationExternalPrerequisite = {
  ...
  downloadUrl:
    "https://global.yuanta.com.tw/NexusPVM/webimage/servisign/YuanTaCGCryptServiSignSetup.pkg",
  ...
  instructions: {
    ...
    "zh-TW":
      "下載並安裝元大官方安全元件。安裝完成後回到這裡，按「重新執行」再試一次。",
  },
};
...
function credentialGroup(
  ...
  return {
    ...input,
    credentialKeys: input.credentialFields.map(
      (credentialField) => credentialField.key,
    ),
  };
}
...
export const AUTOMATION_CREDENTIAL_GROUPS: readonly AutomationCredentialGroup[] =
  [
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the same ID number, user code, and password you use for Taipei Fubon online banking.",
          "請準備登入台北富邦網路銀行時使用的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active Taipei Fubon online banking account",
            "已啟用的台北富邦網路銀行服務",
          ),
          localized(
            "Your online banking user code and password",
            "網路銀行使用者代碼與密碼",
          ),
        ],
        steps: [
          localized(
            "Open Taipei Fubon online banking and confirm that you can sign in.",
            "先開啟台北富邦網路銀行，確認可以正常登入。",
          ),
          localized(
            "Return here and enter the same sign-in details.",
            "回到這裡輸入相同的登入資料。",
          ),
        ],
        links: [
          ...
          link(
            "guide",
            "View online banking information (Chinese)",
            "查看申請／取得說明",
            "https://www.fubon.com/banking/personal/digitalService/index.htm",
            ["www.fubon.com"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the sign-in details registered for E.SUN online banking.",
          "請使用玉山網路銀行已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active E.SUN online banking account",
            "已啟用的玉山網路銀行服務",
          ),
          localized(
            "Your online banking user code and password",
        ...
        steps: [
          localized(
            "Open E.SUN online banking and verify your sign-in details.",
            "先前往玉山網路銀行確認登入資料。",
          ),
          localized(
            "Return here and enter those details.",
            "回到這裡輸入相同資料。",
          ),
        ],
        links: [
          ...
          link(
            "guide",
            "View application guide (Chinese)",
            "查看申請／取得說明",
            "https://www.esunbank.com/zh-tw/about/faq/content?q=online_account%2F021",
            ["www.esunbank.com"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the ID number, user code, and password registered for Yuanta Bank online banking.",
          "請使用元大銀行網路銀行已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active Yuanta Bank online banking account",
            "已啟用的元大銀行網路銀行服務",
          ),
          localized(
            "Your online banking user code and password",
        ...
        steps: [
          localized(
            "Open Yuanta Bank online banking and confirm that you can sign in.",
            "先前往元大銀行網路銀行確認可以登入。",
          ),
          localized(
            "Return here and enter the same sign-in details.",
        ...
        links: [
          link(
            ...
            "Open online banking (Chinese)",
            "前往網路銀行",
            "https://ebank.yuantabank.com.tw/nib/ibanc.jsp",
            ["ebank.yuantabank.com.tw"],
          ),
          link(
            "guide",
            "View digital banking information (Chinese)",
            "查看申請／取得說明",
            "https://www.yuantabank.com.tw/bankwebIMG/event/Bank_Act2025/MobileBankingAPP/index.html",
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Yuanta Securities requires your sign-in details and an exported certificate file for statement access.",
          "元大證券需要登入資料，以及已匯出的憑證檔案才能取得帳務資料。",
        ),
        requirements: [
          localized(
            "Your Taiwan ID number and Yuanta Securities password",
            "台灣身分證字號與元大證券登入密碼",
          ),
          localized(
            "A .pfx or .p12 certificate file and its password",
            ".pfx 或 .p12 憑證檔案及憑證密碼",
          ),
        ],
        steps: [
          localized(
            "Confirm that you can sign in to Yuanta Securities.",
            "先確認可以登入元大證券。",
          ),
          localized(
            "Apply for or renew the certificate, then export a backup certificate file.",
            "申請或更新憑證後，匯出一份憑證備份檔。",
          ),
          localized(
            "Return here, choose the certificate file, and enter its password.",
            "回到這裡選擇憑證檔案並輸入憑證密碼。",
          ),
        ],
        links: [
          link(
            "service",
            "Open securities service (Chinese)",
            "前往證券服務",
            "https://global.yuanta.com.tw/NexusWebTrade/Login/OTPLogin?urlid=6020",
            ["global.yuanta.com.tw"],
          ),
          link(
            "certificate-guide",
            "View certificate application and component installation guide (Chinese)",
            "查看憑證申請與元件安裝說明",
            "https://www.yuanta.com.tw/eYuanta/Securities/Node/Index?C1=2018031206314695&ID=2018031206314695&Level=1&MainId=00414",
            ["www.yuanta.com.tw"],
          ),
          link(
            "installer",
            "Download Yuanta certificate component",
            "下載元大憑證元件",
            "https://global.yuanta.com.tw/NexusPVM/webimage/servisign/YuanTaCGCryptServiSignSetup.pkg",
            ["global.yuanta.com.tw"],
          ),
        ...
        extra: {
          ...
          steps: [
            localized(
              "Download and install the official component before using the certificate service.",
              "請先下載並安裝元大官方憑證元件。",
            ),
            localized(
              "After installation, return to Yuanta Securities to apply for, renew, or export the certificate.",
              "安裝完成後回到元大證券，申請、更新或匯出憑證。",
            ),
            localized(
              "Keep the exported file in a stable location; this app stores its original path and does not copy it.",
              "請把匯出的憑證檔放在固定位置；本應用程式只記錄原始路徑，不會複製檔案。",
            ),
          ],
        },
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the sign-in details registered for Cathay United Bank online banking.",
          "請使用國泰世華網路銀行已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active Cathay United Bank online banking account",
            "已啟用的國泰世華網路銀行服務",
          ),
          localized(
            "Your online banking user code and password",
        ...
        steps: [
          localized(
            "Open Cathay United Bank online banking and confirm that you can sign in.",
            "先前往國泰世華網路銀行確認可以登入。",
          ),
          localized(
            "Return here and enter the same sign-in details.",
        ...
        links: [
          link(
            ...
            "Open online banking (Chinese)",
            "前往網路銀行",
            "https://www.cathaybk.com.tw/MyBank/",
            ["www.cathaybk.com.tw"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the ID number, user code, and password registered for Hua Nan Bank online banking.",
          "請使用華南銀行網路銀行已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active Hua Nan Bank online banking account",
            "已啟用的華南銀行網路銀行服務",
          ),
          localized(
            "Your online banking user code and password",
        ...
        steps: [
          localized(
            "Open Hua Nan Bank online banking and verify your sign-in details.",
            "先前往華南銀行網路銀行確認登入資料。",
          ),
          localized(
            "Return here and enter those details.",
        ...
        links: [
          ...
          link(
            "guide",
            "View online banking help (Chinese)",
            "查看申請／取得說明",
            "https://www.hncb.com.tw/ibankqa/index.shtml",
            ["www.hncb.com.tw"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the ID number, user code, and password registered for CTBC Bank online banking.",
          "請使用中國信託網路銀行已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active CTBC Bank online banking account",
            "已啟用的中國信託網路銀行服務",
          ),
          localized(
            "Your online banking user code and password",
        ...
        steps: [
          localized(
            "Open CTBC Bank online banking and confirm that you can sign in.",
            "先前往中國信託網路銀行確認可以登入。",
          ),
          localized(
            "Return here and enter the same sign-in details.",
        ...
        links: [
          ...
          link(
            ...
            "View online banking information (Chinese)",
            "查看申請／取得說明",
            "https://www.ctbcbank.com/web/content/twrbo/zh_tw/onlinecounter_index/digital_service/digital_service_ib.html",
            ["www.ctbcbank.com"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the ID number, user code, and password registered for Chunghwa Post internet banking.",
          "請使用中華郵政網路郵局已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active internet banking account",
            "已啟用的網路郵局服務",
          ),
          localized(
            "Your user code and web password",
            "網路郵局使用者代碼與網路密碼",
          ),
        ],
        steps: [
          localized(
            "Open internet banking and confirm that you can sign in.",
            "先前往網路郵局確認可以登入。",
          ),
          localized(
            "Return here and enter the same sign-in details.",
        ...
        links: [
          ...
          link(
            ...
            "View application guide (Chinese)",
            "查看申請／取得說明",
            "https://ipost.post.gov.tw/pst/applyForiPost.html",
            ["ipost.post.gov.tw"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the ID number, user code, and password registered for Bank SinoPac MMA online banking.",
          "請使用永豐銀行 MMA 網路銀行已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized(
            "An active MMA online banking account",
            "已啟用的 MMA 網路銀行服務",
          ),
          localized(
            "Your user code and online password",
            "網路銀行使用者代碼與網路密碼",
          ),
        ],
        steps: [
          localized(
            "Open MMA online banking and confirm that you can sign in.",
            "先前往 MMA 網路銀行確認可以登入。",
          ),
          localized(
            "Return here and enter the same sign-in details.",
        ...
        links: [
          ...
          link(
            "guide",
            "View sign-in details guide (Chinese)",
            "查看申請／取得說明",
            "https://bank.sinopac.com/searchmb/FAQ/content.aspx?catID=MMAb2c&no=340&sid=MMA&subCatID=%E7%B6%B2%E9%8A%80%E5%AF%86%E7%A2%BC",
            ["bank.sinopac.com"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Use the sign-in details registered for the LINE Bank web service.",
          "請使用 LINE Bank 網頁服務已註冊的身分證字號、使用者代碼與密碼。",
        ),
        requirements: [
          localized("An active LINE Bank account", "已啟用的 LINE Bank 帳戶"),
          localized("Your web sign-in details", "LINE Bank 網頁登入資料"),
        ],
        steps: [
          localized(
            "Open the LINE Bank web service and confirm that you can sign in.",
            "先前往 LINE Bank 網頁服務確認可以登入。",
          ),
          localized(
            "Return here and enter the same details.",
            "回到這裡輸入相同資料。",
          ),
        ],
        links: [
          ...
          link(
            "guide",
            "View LINE Bank help (Chinese)",
            "查看申請／取得說明",
            "https://www.linebank.com.tw/faq/02",
            ["www.linebank.com.tw"],
          ),
        ],
      },
    ...
    credentialGroup({
      ...
      credentialFields: [
        field(
          ...
          "Mobile phone number (registered with the E-Invoice Platform)",
          "手機號碼（需於電子發票服務平台註冊）",
        ),
        field(
          "LIBRETTO_CLOUD_EINVOICE_PASSWORD",
          "E-Invoice Platform password",
          "電子發票服務平台密碼",
          "password",
        ),
      ],
      setupGuide: {
        ...
        requirements: [
          localized(
            "A mobile phone barcode account registered on the E-Invoice Platform",
            "已在電子發票服務平台註冊的手機條碼帳戶",
          ),
          localized("Your platform password", "電子發票服務平台密碼"),
        ],
        steps: [
          localized(
            "Register or sign in to the E-Invoice Platform and confirm your mobile phone barcode account.",
            "先在電子發票服務平台註冊或登入，確認手機條碼帳戶。",
          ),
          localized(
            "Return here and enter the registered phone number and platform password.",
            "回到這裡輸入已註冊的手機號碼與平台密碼。",
          ),
        ],
        links: [
          link(
            "service",
            "Open E-Invoice Platform (Chinese)",
            "前往電子發票服務平台",
            "https://www.einvoice.nat.gov.tw/accounts/login",
            ["www.einvoice.nat.gov.tw"],
          ),
          link(
            "guide",
            "View mobile barcode registration guide (Chinese)",
            "查看申請／取得說明",
    ...
    credentialGroup({
      ...
      setupGuide: {
        summary: localized(
          "Create a MAX API token to synchronize your MAX wallet and transaction records.",
          "請建立 MAX API 金鑰，以同步 MAX 錢包與交易紀錄。",
        ),
        requirements: [
          localized("A verified MAX account", "已完成驗證的 MAX 帳戶"),
          localized(
            "An API access key and secret key",
            "API 存取金鑰與私密金鑰",
          ),
          localized(
            "The sub-account name, if you use one",
            "如有使用子帳戶，請準備子帳戶名稱",
          ),
        ],
        steps: [
          localized(
            "Sign in to MAX and open Profile settings.",
            "登入 MAX 後開啟個人資料設定。",
          ),
          localized(
            "Open API Token Settings and create a token.",
            "進入 API Token 設定並建立金鑰。",
          ),
          localized(
            "Enable only the read permissions needed for synchronization; withdrawal permission is not required.",
            "只啟用同步所需的讀取權限；不需要開啟提領權限。",
          ),
          localized(
            "Copy the access and secret keys here. Enter a sub-account only when the token belongs to one.",
            "將存取金鑰與私密金鑰填入這裡；只有金鑰屬於子帳戶時才填寫子帳戶。",
          ),
        ],
        links: [
          link(
            ...
            "Open MAX",
            "前往 MAX",
            "https://max.maicoin.com/signin",
            ["max.maicoin.com"],
            "https://max.maicoin.com/signin?lang=en",
          ),
          link(
            "api-guide",
            "View API key setup guide",
            "查看 API 金鑰設定說明",
            "https://campaign.maicoin.com/api",
            ["campaign.maicoin.com"],
            "https://campaign.maicoin.com/en/api",
          ),
          link(
            "api-docs",
            "Open MAX API documentation",
            "前往 MAX API 文件",
            "https://campaign.maicoin.com/api-document",
            ["campaign.maicoin.com"],
            "https://campaign.maicoin.com/en/api-document",
          ),
        ],
        extra: {
          ...
          steps: [
            localized(
              "The secret key may only be shown once. Copy it before leaving the MAX setup screen.",
              "私密金鑰可能只顯示一次，離開 MAX 設定畫面前請先複製。",
            ),
            localized(
              "If you rotate or revoke the token later, return here and replace both keys.",
              "日後若輪替或撤銷金鑰，請回到這裡同時更新兩把金鑰。",
            ),
          ],
        },
      },
...
export const AUTOMATION_TASKS: readonly AutomationTask[] = [
  ...
  {
    id: "fubon-auth-menu-diagnostic",
    label: "Fubon auth-only menu diagnostic",
    script: "run:fubon-auth-menu-diagnostic",
    command: [
      "libretto",
      "run",
  ...
  {
    id: "fubon-approved-loan-menu-diagnostic",
    label: "Fubon approved loan menu diagnostic",
    script: "run:fubon-approved-loan-menu-diagnostic",
    command: [
      "libretto",
      "run",
      "src/workflows/fubon-auth-menu-diagnostic.ts",
  ...
  {
    id: "yuanta-auth-menu-diagnostic",
    label: "Yuanta auth-only menu diagnostic",
    script: "run:yuanta-auth-menu-diagnostic",
    command: [
      "libretto",
      "run",
  ...
  {
    id: "yuanta-approved-function-overview-diagnostic",
    label: "Yuanta approved function overview diagnostic",
    script: "run:yuanta-approved-function-overview-diagnostic",
    command: [
      "libretto",
      "run",
      "src/workflows/yuanta-auth-menu-diagnostic.ts",
...
export const AUTOMATION_CREDENTIAL_KEYS = Array.from(
  new Set(
    AUTOMATION_CREDENTIAL_GROUPS.flatMap((group) => group.credentialKeys),
  ),
);
...
const AUTOMATION_STATEMENT_SELECTION_KEYS =
...
function taskIsEnabled(
  ...
  return (
    !task.credentialGroupId || enabledGroups[task.credentialGroupId] !== false
  );
}
