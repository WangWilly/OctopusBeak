...
assert.match(source, /id="update-hour"/);
assert.match(source, /id="update-minute"/);
assert.match(source, /id="update-meridiem"/);
assert.doesNotMatch(source, /time-picker|time-popover/);
